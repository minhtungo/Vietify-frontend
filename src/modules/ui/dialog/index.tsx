...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'fixed inset-0 z-50 bg-background/40 transition-all duration-200 data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=open]:fade-in',
      className
    )}
    {...props}
  />
...
>(({ className, customClose = false, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      onInteractOutside={customClose ? customClose : () => {}}
      onEscapeKeyDown={customClose ? customClose : () => {}}
      {...props}
    >
      {children}
      {customClose ? (
        <DialogClose
          ...
          onClick={customClose ? customClose : () => {}}
        >
